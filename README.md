...
<hr>
<h3>Full Stack Engineer with over 4 years of hands-on expertise in crafting and implementing efficient solutions using a diverse set of technologies, including JavaScript, HuBL(HubSpot), NodeJS, ReactJS, NodeJS and more. I prioritize KISS, DRY and SOLID principles for robust and maintainable software. My professional journey spans over 14 years as an Industrial Engineer with 7 years as an Engineer at Toyota, where I developed a strong foundation in analytical thinking, effective problem-solving, teamwork, communication, and a commitment to continuous improvement.</h3>
<hr>
...
|-------------|-------------------|---|---|
|    Memxus   | AI Memory | <sup><kbd>***[Repo]([https://memxus.com](https://github.com/gpitrella/memxus-remote-mcp)***</kbd></sup> | <sup><kbd>***[Link](https://memxus.com)***</kbd></sup> |
